          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            <div className="card" style={{ padding: "24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div>
                  <label htmlFor="view-password" style={{ display: "block", fontSize: "12px", fontWeight: 600, color: "#6B6560", marginBottom: "6px" }}>
                ...
                <div>
                  <label htmlFor="edit-password" style={{ display: "block", fontSize: "12px", fontWeight: 600, color: "#6B6560", marginBottom: "6px" }}>
